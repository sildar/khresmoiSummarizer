...
public class Tokenizer implements ITokenizer {
	...
	private Tokenizer() {
		...
		loadAbbreviations(this.getClass().getResource(TokenizerUtils.abbreviations).getFile());
	}
	...
	public synchronized Sentence tokenize(String s, boolean postprocess) {
	...
	public static Sentence postTokenize(Sentence tok_vec) {
	...
	private static Sentence deHyphenate(Sentence tok_vec, String s) {
		int tok_cnt = tok_vec.size();
		int tok_pos = 0;
		TokenInfo ti1 = null;
		TokenInfo ti2 = null;
