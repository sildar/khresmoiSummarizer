 ...
 * StopFilter uses a custom stop word set.
 * 
 * @author Sujit Pal
 */
public class SummaryAnalyzer extends Analyzer {
    ...
    private String[] stopwords = filterComments(StringUtils.split(IOUtils.toString(SummaryAnalyzer.class
                    .getResource(SummarizerUtils.stopwords))));
